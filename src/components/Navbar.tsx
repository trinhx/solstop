	...
	return (
		<>
			<Link to="/">
				...
				<div className="top-0 hidden sm:block">
			...
			<div className="w-full flex items-center justify-center py-8 gap-4 text-gray-500 text-sm">
				...
				<a href="https://twitter.com/eatpizzsol" target="_blank" rel="noreferrer" className="hover:text-white  flex items-center gap-1">
					...
					<p className="hidden sm:flex">TWITTER</p>
				</a>

				<a href="https://discord.gg/mD4G5zzyyc" target="_blank" rel="noreferrer" className="hover:text-white  flex items-center gap-1">
					<svg width="22" height="17" viewBox="0 0 71 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

	...
	return (
		<div>
			<p className="w-10/12 max-w-3xl mx-auto mb-10 text-gray-300 leading-relaxed">
                ...
                <h1 className="text-2xl font-semibold text-center mt-10 mb-10">
                    Pizzsols will bridge human senses to the metaverse via the world's universal food...
                    Pizza!
                </h1>

				PizzSol is randomly generated pizza ingredients on the Solana blockchain. Images and Stats
                are intentionally ommited allowing others to interpret and use in anyway they want. Each PizzSol is
				comprised of a unique base, meats, vegetables, cheeses and sauces. For more information on our
                roadmap, FAQ etc, join our

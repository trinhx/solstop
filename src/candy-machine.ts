...
export const getCandyMachineState = async (anchorWallet: anchor.Wallet, candyMachineId: anchor.web3.PublicKey, connection: anchor.web3.Connection): Promise<CandyMachineState> => {
	...
	let mintPrice = state.data.price.toNumber();

	// DEV
	// console.log(goLiveDate * 1000);
	// console.log('state', state);
	// console.log(state.data.price.toString());
	// console.log('auth', state.data.config);
